...
print(Fore.GREEN + "===========================================================")
print(Fore.GREEN + "                     PyCript v 0.1")
print(Fore.GREEN + "===========================================================")
print("Seleccione el archivo que desee encriptar")
...
try:
    ...
    if not archive_status:
        ...
        print(Fore.YELLOW + f"Encriptar '{archive_directory}'?")
...
new_archive = open("encripter.txt", "w")
new_archive.write("")
...
for li in range(0, len(archive.readlines())):
    ...
    for le in range(0, len(archive.readlines()[li])):
        ...
        password_counter += 1
        new_archive = open("encripter.txt", "a")
