...
def presentation(n: str):
    print(n)
    print(Fore.GREEN + "===============================================================")
    print(Fore.GREEN + Style.BRIGHT + "              DesPyCript v 1")
    print(Fore.GREEN + "===============================================================")
...
while archive_correct:
    ...
    print(Fore.YELLOW + "\n-- Seleccione el archivo que desee desencriptar")
    ...
    try:
        ...
        if not archive_status:
            ...
            while confirmation_ansewer: 
                ...
                print(Fore.YELLOW + f" -- Desencriptar '{archive_directory}'? y/n")
...
new_archive = open("desencriptado.txt", "w")
new_archive.write("")
archive = open(archive_directory, "r")
